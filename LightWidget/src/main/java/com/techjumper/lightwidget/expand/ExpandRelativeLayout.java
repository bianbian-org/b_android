...
public class ExpandRelativeLayout extends RelativeLayout {
    ...
    public ExpandRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ExpandRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
