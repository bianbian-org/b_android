...
public class AdvancedWebView extends WebView {
    ...
    public interface Listener {
        ...
        void onPageHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse);
    ...
    protected void init(Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
                ...
                if (mListener != null) {
                    mListener.onPageHttpError(view, request, errorResponse);
                }

                if (mCustomWebViewClient != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
