 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
public class RegistActivityPresenter extends AppBaseActivityPresenter<RegistActivity> {

    private RegistActivityModel mModel = new RegistActivityModel(this);
...
//        );
    ...
    private void register() {
        getView().showLoading(false);
        addSubscription(
                mModel.regist(getView().getPhoneNumber()
