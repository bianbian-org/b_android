...
public class ComplainDetailActivityModel extends BaseModel<ComplainDetailActivityPresenter> {
    ...
    private int getDataId() {
        return getPresenter().getView().getIntent().getExtras().getInt(Constant.PROPERTY_DATA_ID, -1);
    }
    ...
    public List<DisplayBean> getAlreadyChoosedPic(ComplainDetailEntity complainDetailEntity) {
    ...
    public Observable<ComplainDetailEntity> getComplainDetail() {
