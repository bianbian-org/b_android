 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
public class MessageAllFragmentModel extends BaseModel<MessageAllFragmentPresenter> {
    ...
    public MessageAllFragmentModel(MessageAllFragmentPresenter presenter) {
        super(presenter);
    }
    ...
    public void updateData(MessageEntity entity) {
        ...
        if (mIsFirst) {
            ...
            messageBigTitleData.setTitle_name(getPresenter().getView().getResources().getString(R.string.message_all));
