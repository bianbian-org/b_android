 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
public class MessageSystemFragmentModel extends BaseModel<MessageSystemFragmentPresenter> {
    ...
    public MessageSystemFragmentModel(MessageSystemFragmentPresenter presenter) {
        super(presenter);
    }
    ...
    public void updateData(MessageEntity entity) {
        ...
        if (mIsFirst) {
            ...
            messageBigTitleData.setTitle_name(getPresenter().getView().getResources().getString(R.string.message_system));
