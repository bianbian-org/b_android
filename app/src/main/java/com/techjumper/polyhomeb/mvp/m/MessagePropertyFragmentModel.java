 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
public class MessagePropertyFragmentModel extends BaseModel<MessagePropertyFragmentPresenter> {
    ...
    public MessagePropertyFragmentModel(MessagePropertyFragmentPresenter presenter) {
        super(presenter);
    }
    ...
    public void updateData(MessageEntity entity) {
        ...
        if (mIsFirst) {
            ...
            messageBigTitleData.setTitle_name(getPresenter().getView().getResources().getString(R.string.message_property));
