 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
@Presenter(FindPasswordActivityPresenter.class)
public class FindPasswordActivity extends AppBaseActivity<FindPasswordActivityPresenter> {
    ...
    protected View inflateView(Bundle savedInstanceState) {
        return inflate(R.layout.activity_find_password);
    }
    ...
    public String getLayoutTitle() {
        return getString(R.string.regist_find_password);
    }
