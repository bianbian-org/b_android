 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
public class MessageFriendFragmentModel extends BaseModel<MessageFriendFragmentPresenter> {
    ...
    public MessageFriendFragmentModel(MessageFriendFragmentPresenter presenter) {
        super(presenter);
    }
    ...
    public void updateData(MessageEntity entity) {
        ...
        if (mIsFirst) {
            ...
            messageBigTitleData.setTitle_name(getPresenter().getView().getResources().getString(R.string.message_friend));
