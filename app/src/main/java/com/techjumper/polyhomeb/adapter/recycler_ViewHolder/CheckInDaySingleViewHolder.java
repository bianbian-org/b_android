 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
@DataBean(data = CheckInDayDataSingle.class,beanName = "CheckInDayDataSingleBean")
public class CheckInDaySingleViewHolder extends BaseRecyclerViewHolder<CheckInDayDataSingle> {

    public static final int LAYOUT_ID = R.layout.item_check_in_day;

    public CheckInDaySingleViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setData(CheckInDayDataSingle data) {
        if (data == null) return;
