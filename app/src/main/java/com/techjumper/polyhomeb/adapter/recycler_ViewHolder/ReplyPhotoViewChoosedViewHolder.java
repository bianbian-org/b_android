 ...
 * * * * * * * * * * * * * * * * * * * * * * *
 **/
@DataBean(beanName = "ReplyPhotoViewChoosedBean", data = ReplyPhotoViewChoosedData.class)
public class ReplyPhotoViewChoosedViewHolder extends BaseRecyclerViewHolder<ReplyPhotoViewChoosedData> {

    public static final int LAYOUT_ID = R.layout.item_new_repair_photo_view_default_plus;

    public ReplyPhotoViewChoosedViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setData(ReplyPhotoViewChoosedData data) {
        if (data == null) return;
