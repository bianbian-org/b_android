 ...
 */
@DataBean(beanName = "InfoReplyLeftEntityBean", data = ReplyEntity.class)
public class MessageLeftViewHolder extends BaseRecyclerViewHolder<ReplyEntity> {

    public static final int LAYOUT_ID = R.layout.item_message_left;
    ...
    public void setData(ReplyEntity data) {
        ...
        setText(R.id.name, getContext().getString(R.string.property));
